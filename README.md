...
The architecture of the implementation is shown in the figure below, and furtherly explained in the [presentation](https://github.com/igor-iurevici/nyc-vehicle-accidents-clustering/blob/main/Presentation.pdf) (not yet available).
<p align="center">
